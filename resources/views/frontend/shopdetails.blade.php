                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="{{route('masterpage')}}">About</a></li>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-product-area mb-100">
                        ...
                        <div class="product-info mt-15 text-center">
                            <div class="row" >
                                {{-- <div class="col-xl-12"> --}}
                                    <center><table  cellspacing="900px" cellpadding="800px" style="align:center;">
                                  
                                   

                                <td><img src="{{asset($shop->photo)}}" class="img-fluid" style="width: 700px; height:200px;">
                                </td>
                                ...
                                <td><b>Name</b>: {{$shop->name}}<br>
                                <b>Price</b>: {{$shop->price}} KS<br>
                                <b>Description</b>: {{$shop->description}}<br>
                                <b>Technology</b>: {{$shop->technology}}
                                </td>
                                </table></center>
