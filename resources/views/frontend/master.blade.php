            ...
            <div class="row justify-content-between">
                    ...
                    <div class="alazea-service-area mb-100">
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <div class="service-icon mr-30">
                                <img src="{{asset('frontend/img/core-img/s1.png')}}" alt="">
                            </div>
                            <!-- Content -->
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                            <!-- Icon -->
                            <div class="service-icon mr-30">
                                <img src="frontedend/img/core-img/s2.png" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="500ms">
                            <!-- Icon -->
                            <div class="service-icon mr-30">
                                <img src="{{asset('frontend/img/core-img/s3.png')}}" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                ...
                <div class="col-12 col-lg-6">
                    <div class="alazea-video-area bg-overlay mb-100">
                        <img src="frontedend/img/bg-img/23.jpg" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="frontedend/img/core-img/b1.png" alt="">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('frontend/img/core-img/b2.png')}}" alt="">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('frontend/img/core-img/b3.png')}}" alt="">
                                    <h5>100% Natural</h5>
                                    <p>Intiam eu sagittis est, at commodo lacini libero. Praesent dignissim sed odio vel aliquam manta lagorn.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="{{asset('frontend/img/core-img/b4.png')}}" alt="">
